                            ...
                            <div class="col-md-6 position-relative">
                                <div>
                                    ...
                                    <label for="admin_logo"
                                        class="border p-4 d-flex justify-content-center mb-5 cursor-pointer">
                                        ...
                                        <input type="file" class="form-control position-absolute" id="admin_logo"
                                            name="admin_logo"
                            ...
                            <div class="col-md-6 position-relative">
                                <div>
                                    ...
                                    <label for="front_logo"
                                        ...
                                        <input type="file" class="form-control position-absolute d-none" id="front_logo"
                                            name="front_logo"
                                            style="opacity: 0; cursor: pointer; height: 200px; width: 200px; top: 0; left: 0;"
