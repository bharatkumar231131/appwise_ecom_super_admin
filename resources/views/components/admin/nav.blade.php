<div class="sa-app__sidebar">
    <div class="sa-sidebar">
        <div class="sa-sidebar__header">
            <a class="sa-sidebar__logo" href="https://123ecommerce.co.za/admin/dashboard">
                                        ...
                                        <ul class="sa-nav__menu sa-nav__menu--root">
                                            ...
                                            <li class="sa-nav__menu-item sa-nav__menu-item--has-icon"
                                                ...
                                                <a href="#" class="sa-nav__link" data-sa-collapse-trigger="">
                                                    <span class="sa-nav__icon">
                                                        ...
                                                        </svg><!-- <i class="fas fa-tags"></i> Font Awesome fontawesome.com -->
                                                        <!-- New icon for Attribute Management -->
                                                    </span>
                                                    <span class="sa-nav__title">Attribute Management</span>
                                                ...
                                                <ul class="sa-nav__menu sa-nav__menu--sub" data-sa-collapse-content="">
                                                    <li class="sa-nav__menu-item">
                                                        <a href="#" class="sa-nav__link">
                                                            ...
                                                            <span class="sa-nav__title">Product Attribute</span>
                                                        </a>
                                                    </li>
                                                    <li class="sa-nav__menu-item">
                                                        <a href="#" class="sa-nav__link">
                                                            <span class="sa-nav__menu-item-padding"></span>
                                                            <span class="sa-nav__title">Attribute Value</span>
                                                        </a>
                                                    </li>
                                                </ul>
                                            </li>
                                            ...
                                            <li class="sa-nav__menu-item sa-nav__menu-item--has-icon"
                                                ...
                                                <a href="#" class="sa-nav__link" data-sa-collapse-trigger="">
                                                    ...
                                                    <span class="sa-nav__title">Orders
                                                        Management</span>
                                                    <span class="sa-nav__arrow"><svg xmlns="http://www.w3.org/2000/svg" width="6" height="9"
                                                ...
                                                <ul class="sa-nav__menu sa-nav__menu--sub" data-sa-collapse-content="">
                                                    ...
                                                    <li class="sa-nav__menu-item">
                                                        <a href="#" class="sa-nav__link"><span class="sa-nav__menu-item-padding"></span>
                                                            <span class="sa-nav__title">Return
                                                                Orders</span>
                                                        </a>
                                                    </li>
                                            ...
                                            <li class="sa-nav__menu-item sa-nav__menu-item--has-icon"
                                                ...
                                                <a href="#" class="sa-nav__link" data-sa-collapse-trigger="">
                                                    <span class="sa-nav__icon">
                                                        <svg class="svg-inline--fa fa-window-maximize fa-w-16" aria-hidden="true" focusable="false"
                                                            data-prefix="fas" data-icon="window-maximize" role="img"
                                                        ...
                                                        </svg><!-- <i class="fas fa-window-maximize"></i> Font Awesome fontawesome.com -->
                                                    </span>
                                                    <span class="sa-nav__title">Banner
                                                        Management</span>
                                                    <span class="sa-nav__arrow"><svg xmlns="http://www.w3.org/2000/svg" width="6" height="9"
                                                            viewBox="0 0 6 9" fill="currentColor">
                                                            <path
                                            ...
                                            <li class="sa-nav__menu-item sa-nav__menu-item--has-icon"
                                                ...
                                                <a href="#" class="sa-nav__link" data-sa-collapse-trigger="">
                                                    <span class="sa-nav__icon">
                                                        <svg class="svg-inline--fa fa-puzzle-piece fa-w-18" aria-hidden="true" focusable="false"
                                                            data-prefix="fas" data-icon="puzzle-piece" role="img" xmlns="http://www.w3.org/2000/svg"
                                                        ...
                                                        </svg><!-- <i class="fas fa-puzzle-piece"></i> Font Awesome fontawesome.com -->
                                                    </span>
                                                    <span class="sa-nav__title">Section
                                                        Management</span>
                                                    <span class="sa-nav__arrow"><svg xmlns="http://www.w3.org/2000/svg" width="6" height="9"
                                                            viewBox="0 0 6 9" fill="currentColor">
                                                            <path
                                                ...
                                                <ul class="sa-nav__menu sa-nav__menu--sub" data-sa-collapse-content="">
                                                    <li class="sa-nav__menu-item">
                                                        <a href="#" class="sa-nav__link"><span class="sa-nav__menu-item-padding"></span>
                                                            <span class="sa-nav__title">Sections</span>
                                                        </a>
                                                    </li>
                                                </ul>
                                            </li>
                                            ...
                                            <li class="sa-nav__menu-item sa-nav__menu-item--has-icon"
                                                ...
                                                <a href="#" class="sa-nav__link" data-sa-collapse-trigger="">
                                                    <span class="sa-nav__icon">
                                                        <svg class="svg-inline--fa fa-th fa-w-16" aria-hidden="true" focusable="false"
                                            ...
                                            <li class="sa-nav__menu-item sa-nav__menu-item--has-icon"
                                                ...
                                                <a href="#" class="sa-nav__link" data-sa-collapse-trigger="">
                                                    <span class="sa-nav__icon">
                                                        <svg class="svg-inline--fa fa-filter fa-w-16" aria-hidden="true" focusable="false"
                                                    ...
                                                    <span class="sa-nav__title">Filter
                                                        Management</span>
                                                    <span class="sa-nav__arrow"><svg xmlns="http://www.w3.org/2000/svg" width="6" height="9"
                                                            viewBox="0 0 6 9" fill="currentColor">
                                                            <path
                                                ...
                                                <ul class="sa-nav__menu sa-nav__menu--sub" data-sa-collapse-content="">
                                                    <li class="sa-nav__menu-item">
                                                        <a href="#" class="sa-nav__link"><span class="sa-nav__menu-item-padding"></span>
                                                            <span class="sa-nav__title">Filters</span>
                                                        </a>
                                                    </li>
                                                </ul>
                                            </li>
