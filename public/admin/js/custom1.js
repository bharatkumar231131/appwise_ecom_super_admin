...
$(document).ready(function () {
    ...
    $("#current_password").keyup(function () {
        ...
        $.ajax({
            ...
            type: "post",
            url: "/appwise/admin/check-admin-password", // check the web.php for this route and check the AdminController for the checkAdminPassword() method
    ...
    $(document).on("click", ".updateAdminStatus", function () {
        // '.updateAdminStatus' is the anchor link <a> CSS class    // This is the same as    $('.updateAdminStatus').on('click', function() {
    ...
    $(document).on("click", ".updateBrandStatus", function () {
        // '.updateBrandStatus' is the anchor link <a> CSS class    // This is the same as    $('.updateBrandStatus').on('click', function() {
        var status = $(this).children("i").attr("status"); // Using HTML Custom Attributes
    ...
    $(document).on("click", ".updateProductStatus", function () {
        // '.updateProductStatus' is the anchor link <a> CSS class    // This is the same as    $('.updateProductStatus').on('click', function() {
        var status = $(this).children("i").attr("status"); // Using HTML Custom Attributes
    ...
    $(document).on("click", ".updateAttributeStatus", function () {
        // '.updateAttributeStatus' is the anchor link <a> CSS class    // This is the same as    $('.updateAttributetatus').on('click', function() {
        var status = $(this).children("i").attr("status"); // Using HTML Custom Attributes
    ...
    $(document).on("click", ".updateImageStatus", function () {
        // '.updateImageStatus' is the anchor link <a> CSS class    // This is the same as    $('.updateAttributetatus').on('click', function() {
        var status = $(this).children("i").attr("status"); // Using HTML Custom Attributes
    ...
    $(document).on("click", ".updateBannerStatus", function () {
        // '.updateBannerStatus' is the anchor link <a> CSS class    // This is the same as    $('.updateBannerstatus').on('click', function() {
        var status = $(this).children("i").attr("status"); // Using HTML Custom Attributes
    ...
    $(document).on("click", ".updateFilterStatus", function () {
        // '.updateFilterStatus' is the anchor link <a> CSS class    // This is the same as    $('.updateFilterstatus').on('click', function() {
        var status = $(this).children("i").attr("status"); // Using HTML Custom Attributes
    ...
    $(document).on("click", ".updateFilterValueStatus", function () {
        // '.updateFilterValueStatus' is the anchor link <a> CSS class    // This is the same as    $('.updateFilterValuestatus').on('click', function() {
        var status = $(this).children("i").attr("status"); // Using HTML Custom Attributes
        var filter_id = $(this).attr("filter_id"); // Using HTML Custom Attributes
    ...
    $(document).on("click", ".updateCouponStatus", function () {
        // '.updateCouponStatus' is the anchor link <a> CSS class    // This is the same as    $('.updateCouponStatus').on('click', function() {
        var status = $(this).children("i").attr("status"); // Using HTML Custom Attributes
    ...
    $(document).on("click", ".updateUserStatus", function () {
        // '.updateUserStatus' is the anchor link <a> CSS class    // This is the same as    $('.updateUserStatus').on('click', function() {
        var status = $(this).children("i").attr("status"); // Using HTML Custom Attributes
    ...
    $(document).on("click", ".confirmDelete", function () {
        // correcting the issue of .confirmDelete (Delete button is not working) is not working when going to the next page (using pagination)
    ...
    // console.log(wrapper);
    // var fieldHTML =
    //     '<div><div style="height:10px"></div><input type="text" name="size[]" placeholder="Size" style="width:100px">&nbsp;<input type="text" name="sku[]" placeholder="SKU" style="width:100px">&nbsp;<input type="text" name="price[]" placeholder="Price" style="width:100px">&nbsp;<input type="text" name="stock[]" placeholder="Stock" style="width:100px">&nbsp;<a href="javascript:void(0);" class="remove_button">Remove</a></div>'; //New input field html
    ...
    $("#order_status").on("change", function () {
        if (this.value == "Shipped") {
            // is the same as:    if ($(this).val() == 'Shipped') {
            $("#courier_name").show();
